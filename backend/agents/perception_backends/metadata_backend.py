"""Rule-based perception from world metadata. No vision; deterministic."""
...
class MetadataPerceptionBackend:
    """Backend that produces PerceptionResult from world objects. No image input."""
    ...
    def perceive_from_objects(
        ...
        return perceive_from_objects(obstacle_objects, target_object, request)
    ...
    def perceive_image(
        ...
        return PerceptionResult(
            detected_targets=[],
            detected_obstacles=[],
            message="Metadata backend does not support image input",
        )
